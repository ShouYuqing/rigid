...
def rigid_net(vol_size, enc_nf, dec_nf):
    ...
    affine_matrix1 = Reshape((4))(affine_matrix1)
    ...
    affine_matrix2 = Reshape((4))(affine_matrix2)
    ...
    affine_matrix3 = Reshape((4))(affine_matrix3)
...
def my_reshape(flow1):
    """
    adjust the dimension of the input flow, add two dimensions
