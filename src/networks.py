...
def rigid_net(vol_size, enc_nf, dec_nf):
    ...
    tf.reshape(flow1,shape = [flow1.get_shape()[0].value,flow1.get_shape()[0].value,flow1.get_shape()[0].value,
                              flow1.get_shape()[0].value,1])
    flow2 = flow[:,:,:,:,1]
    tf.reshape(flow2, shape=[flow2.get_shape()[0].value, flow2.get_shape()[0].value, flow2.get_shape()[0].value,
                             flow2.get_shape()[0].value, 1])
    flow3 = flow[:,:,:,:,2]
    tf.reshape(flow1, shape=[flow3.get_shape()[0].value, flow3.get_shape()[0].value, flow3.get_shape()[0].value,
                             flow3.get_shape()[0].value, 1])
